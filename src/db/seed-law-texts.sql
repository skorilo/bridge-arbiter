-- Law texts extracted from official PDFs (DE: ÖBV 2017, RO: FRB 2017)
-- Rule 31 text is managed by seed-rule31.sql — this file updates the other 92 laws.

UPDATE rules SET
  text_de = 'A. Rang der Karten und Farben
...
B. Bildseite der Karten
Der Zuständige Verband kann verlangen, dass die Bildseiten der Karten symmetrisch sind.

C. Rückseite der Karten
Die Rückseiten aller 52 Karten sollen identisch sein. Sie können Wörter, Logos oder Bilder
enthalten, das Gesamtbild soll aber zentrisch symmetrisch sein.',
  text_ro = 'A. Rangul Cărților și Culorilor
...
Autoritatea Regulatoare poate cere ca fața fiecărei cărți să fie simetrică.
...
UPDATE rules SET
  text_de = 'Für jede Austeilung, die in einem Durchgang zu spielen ist, gibt es ein Board mit einem
...
doch verwendet, gelten in diesem Durchgang die darauf markierten Bedingungen.',
  text_ro = 'Pentru fiecare donă care trebuie jucată pe parcursul unei sesiuni se asigură un etui
...
etui este folosit pentru sesiunea respectivă, se respectă condiţiile înscrise pe acesta.'
WHERE number = '2';

UPDATE rules SET
  text_de = 'An jedem Tisch spielen vier Spieler, und die Tische sind in einer Reihenfolge, die der
Turnierleiter festlegt, nummeriert. Er legt eine Richtung als Nord fest; die anderen
Windrichtungen stehen zu Nord in der üblichen Beziehung.',
  text_ro = 'La fiecare masă joacă 4 jucători, iar mesele sunt numerotate într-o ordine stabilită de
arbitru. Acesta desemnează direcţia Nord, determinând automat celelalte 3 puncte
cardinale prin relația lor cu Nordul.'
WHERE number = '3';

UPDATE rules SET
  text_de = 'Die vier Spieler an einem Tisch bilden zwei Partnerschaften oder Seiten, Nord-Süd gegen
...
wechseln während eines Durchgangs.',
  text_ro = 'Cei 4 jucători de la fiecare masă formează două perechi sau axe, Nord-Sud contra
...
separat şi perechile se schimbă pe parcursul sesiunii.'
WHERE number = '4';

UPDATE rules SET
  text_de = 'A. Startposition
...
mit Erlaubnis des Turnierleiters wechseln.
...
respectivă decât la indicaţia sau cu permisiunea arbitrului.

B. Schimbarea Poziției Inițiale sau a Mesei
...
către arbitru şi de a se așeza în locul corect după fiecare shimbare.'
WHERE number = '5';

UPDATE rules SET
  text_de = 'A. Mischen
Vor Beginn des Spiels wird jedes Kartenpaket gründlich gemischt. Wenn ein Gegner es
wünscht, darf er abheben.
...
geteilt werden. Es wird empfohlen, die Karten im Uhrzeigersinn in Kreis zu teilen.

C. Anwesenheit beider Paare
Ein Mitglied jeder Seite sollte während des Mischens und Teilens anwesend sein, wenn der
Turnierleiter nichts anderes anordnet.

D. Neuerliches Mischen und Teilen
...
Mischen und Teilen anordnen (siehe aber Regeln 22B und 86A).

E. Mischen und Teilen im Ermessen des Turnierleiters
...
dieselben völlig zufälligen Verteilungen wie oben A. und B. herstellt.

F. Duplizieren der Boards
...
der Turnierleiter befugt, das dennoch anzuordnen.',
  text_ro = 'A. Amestecarea Cărților

Fiecare pachet se amestecă minuțios înainte de începerea jocului. Pachetul este
tăiat la solicitarea oricăruia dintre oponenți.

B. Distribuirea Cărților
...
C. Prezența unui Reprezentant al Fiecărei Axe

În timpul amestecării şi distribuirii cărţilor ar trebui să fie prezent minim un membru al
fiecărei axe, exceptând cazul când arbitrul dă alte dispoziţii.

D. Reamestecarea și Redistribuirea Cărților
...
compatibil cu Legile (dar vezi Legea 22B și Legea 86A).

E. Opțiunile Arbitrului de Amestecare și Distribuire a Cărților
...
redistribuire a unei done (deşi arbitrul are puterea să o impună).'
WHERE number = '6';

UPDATE rules SET
  text_de = 'A. Auflegen des Boards
Wenn ein Board gespielt werden soll, wird es in die Tischmitte gelegt; dort muss es richtig
ausgerichtet liegen bleiben, bis das Spiel beendet ist.

B. Herausnehmen der Karten
...
(aber der Alleinspieler kann die Karten des Strohmanns nach Regel 45 spielen).

C. Zurückgeben der Karten ins Board
...
oder der Turnierleiter anwesend ist.

D. Verantwortung für die Ordnung am Tisch
Jeder Teilnehmer, der während eines Durchganges an einem Tisch bleibt, ist in erster Linie
für korrekte Spielbedingungen verantwortlich.',
  text_ro = 'A. Plasarea Etuiului pe Masă

Când un etui trebuie jucat, el este aşezat în centrul mesei, unde rămâne, corect
orientat, până când jocul ia sfârşit.

B. Scoaterea Cărților din Etui
...
adversar sau a arbitrului.

C. Reintroducerea Cărților în Etui
...
D. Responsabilitatea pentru Corectitudinea Procedurilor

Jucătorii care rămân la aceeași masă pe întreg parcursul unei sesiuni sunt principalii
responsabili pentru menținerea condiţiilor adecvate de joc la acea masă.'
WHERE number = '7';

UPDATE rules SET
  text_de = 'A. Bewegung der Boards und Spieler
...
den richtigen Tisch weiter gegeben werden.
...
wenn der Turnierleiter das Board gestrichen hat.

C. Ende der letzten Runde und des Durchgangs
...
eingetragen sind.',
  text_ro = 'A. Deplasarea Etuiurilor şi a Jucătorilor
...
scorul consimțit şi înregistrat, sau când arbitrul anulează jucarea donei.

C. Terminarea Ultimei Runde și Terminarea Sesiunii
...
scorurile au fost introduse fără obiecţii.'
WHERE number = '8';

UPDATE rules SET
  text_de = 'A. auf eine Regelwidrigkeit aufmerksam machen
...
(siehe aber Regel 20F5 bei einer vermeintlich falschen Auskunft des Partners).

B. Nachdem auf eine Regelwidrigkeit aufmerksam gemacht worden ist
...
C. Vorzeitiges Ausbessern einer Regelwidrigkeit
Jedes vorzeitige Ausbessern einer Regelwidrigkeit durch einen schuldigen Spieler kann ihn
weiteren Korrekturen unterwerfen (siehe die Ausspielbeschränkungen in Regel 26B).',
  text_ro = 'A. Atragerea Atenției asupra unei Neregularități
...
B. După ce s-a Atras Atenția asupra unei Neregularități
...
C. Corectarea Prematură a unei Neregularități

Orice corectare prematură a unei neregularităţi de către jucătorul vinovat îl poate
supune pe acesta la o rectificare ulterioară (vezi restricţiile de atac din Legea 26B) .'
WHERE number = '9';

UPDATE rules SET
  text_de = 'A. Recht, eine Korrektur festzulegen
Allein der Turnierleiter ist berechtigt, gegebenenfalls Korrekturen festzulegen. Spieler haben
nicht das Recht, selbstständig Korrekturen festzulegen (oder zu erlassen – siehe Regel 81C5).

B. Aufhebung von Festlegung oder Erlassung einer Korrektur
Wenn Spieler ohne Anweisung des Turnierleiters eine Korrektur festgelegt oder erlassen
haben, kann der Turnierleiter das bestätigen oder aufheben.

C. Wahlmöglichkeit nach einer Regelwidrigkeit
...
72C).',
  text_ro = 'A. Dreptul de a Decide o Rectificare

Numai arbitrul are dreptul de a decide când se impun rectificări. Jucătorii nu au
dreptul de a impune (sau suprima – vezi Legea 81C5) rectificări din proprie iniţiativă.

B. Anularea Impunerii sau Suprimării unei Rectificări
Arbitrul poate permite sau anula orice impunere sau suprimare a unei rectificări
făcută de jucători fără avizul său.

C. Opțiuni după Comiterea unei Neregularități
...
infracţiune (dar vezi Legile 27 şi 72C).'
WHERE number = '10';

UPDATE rules SET
  text_de = 'A. Aktion der nicht-schuldigen Seite
...
bleibt das Tischergebnis.

B. Strafe nach Verlust des Anspruchs auf Korrektur
Auch wenn auf Grund dieser Regel der Anspruch auf Korrektur verloren gegangen ist, kann
der Turnierleiter eine Ordnungsstrafe (siehe Regel 90) verhängen.',
  text_ro = 'A. Acțiuni ale Axei Nevinovate
...
B. Penalizare după Pierderea Dreptului la Rectificare

Chiar după pierderea dreptului la rectificare prin aplicarea acestei legi, arbitrul poate
dicta o penalizare procedurală (vezi Legea 90) .'
WHERE number = '11';

UPDATE rules SET
  text_de = 'A. Befugnis, ein Berichtigtes Ergebnis zuzuweisen
...
einer Regelwidrigkeit erfolgt ist.

B. Zweck der Berichtigung
...
C. Zuweisen eines Berichtigten Ergebnisses
...
Board getrennt berechnet, und beiden das arithmetische Mittel zugewiesen.',
  text_ro = 'A. Puterea de a Acorda un Scor Ajustat
...
B. Obiectivele Ajustării Scorului
...
aceste Legi este fie prea severă, fie prea avantajoasă pentru una dintre părți.

C. Acordarea unui Scor Ajustat
...
primesc media celor două scoruri.'
WHERE number = '12';

UPDATE rules SET
  text_de = 'A. vor der ersten Ansage
...
zuweisen [siehe Regel 12C1(b)]; er kann einen schuldigen Spieler bestrafen.

B. Während Lizitation oder Spiel bemerkt
...
12C1(b)]; er kann einen schuldigen Spieler bestrafen.
...
sein). Über einen schuldigen Teilnehmer kann eine Ordnungsstrafe verhängt werden.',
  text_ro = 'A. Înaintea Oricărei Declarații
...
cazuri care implică un pachet de cărți incomplet.
B. Descoperit în Timpul Licitației sau Jocului
...
scor ajustat [vezi Legea 12C1b)] şi poate penaliza un concurent vinovat.
...
descoperă că o astfel de carte a fost jucată la o levată deja încheiată.
...
UPDATE rules SET
  text_de = 'A. Mangel vor der Spielphase bemerkt
...
angenommen, dass das rekonstruierte Blatt von Anfang an aus allen Karten bestanden hat.

B. Mangel erst später bemerkt
...
Nichtspielen kann eine Revoke sein.

C. Information vom Hinzufügen einer Karte
Das Hinzufügen einer Karte ist für den Partner des Spielers, dessen Blatt eine falsche
Kartenanzahl hatte, eine unerlaubte Information.',
  text_ro = 'A. Mână Incompletă Descoperită Înaintea Începerii Jocului
...
considerându-se că mâna reîntregită a avut de la început toate cărţile.

B. Mână Incompletă Descoperită Ulterior
...
penalizată şi omisiunea de a o fi jucat poate constitui o renonsă.

C. Informația despre Reîncadrarea Cărții Lipsă

Informaţia despre reîncadrarea unei cărţi în mâna incompletă este neautorizată
pentru partenerul jucătorului a cărui mână a conţinut un număr incorect de cărţi.'
WHERE number = '14';

UPDATE rules SET
  text_de = 'A. Karten aus einem falschen Board
...
4. Eine Ordnungsstrafe (Regel 90) kann zusätzlich zu diesen Korrekturen verhängt werden.

B. Falsches Board (nach Beginn der Lizitationsphase)15.2
...
gültiges Ergebnis auf diesem Board zu erzielen, ein KBE [siehe Regel 12C2(a)] zuweisen.',
  text_ro = 'A. Cărți dintr-un Etui Greșit
...
B. Donă Greșită Descoperită în Timpul Licitației sau Jocului4
...
privat de posibilitatea de a obține un scor valid.'
WHERE number = '15';

UPDATE rules SET
  text_de = 'A. Verwendung von Informationen durch die Spieler
...
für dieses Turnier berücksichtigen.
...
ein schuldiger Spieler durch einen Regelverstoß einen Vorteil erlangt hat.

C. Information aus zurück genommenen Ansagen und Spielen
...
16.1 Den Turnierleiter früher oder später zu rufen, ist kein Regelverstoß.
D. Spielfremde Information aus anderen Quellen
...
des Boards erhalten worden ist, geht der Turnierleiter nach Regel 16D2(c) oder 16D2(d) vor.',
  text_ro = 'A. Utilizarea Informațiilor de către Jucători
...
caracteristicile adversarilor şi de orice cerinţă din regulamentului turneului.

B. Informație Ilicită de la Partener
...
C. Informație Provenită din Declarații sau Jocuri Retrase
...
încălcare a punctului C2 a prejudiciat axa nevinovată.

D. Informație Ilicită din Alte Surse
...
5 Nu este o infracțiune să chemi arbitrul mai devreme sau mai târziu.'
WHERE number = '16';

UPDATE rules SET
  text_de = 'A. Beginn
Die Lizitationsphase auf einem Board beginnt für eine Seite, wenn einer der Partner seine
Karten aus dem Board nimmt.

B. erste Ansage
Der Spieler, der auf dem Board als Teiler gekennzeichnet ist, macht die erste Ansage.

C. nachfolgende Ansagen
Der Spieler links vom Teiler macht die zweite Ansage, und danach sagt jeder Spieler der
Reihe nach im Uhrzeigersinn an.
...
schuldig gilt.',
  text_ro = 'A. Începerea Perioadei de Licitație

Perioada de licitație a unei done incepe pentru o axă când oricare din cei doi
parteneri își scoate cărţile din etui.

B. Prima Declarație

Jucătorul marcat pe etui ca distribuitor face prima declaraţie.

C. Succesiunea Declarațiilor

Jucătorul din stânga distribuitorului face a doua declaraţie, iar apoi fiecare declară pe
rând, în sensul acelor de ceasornic.

D. Terminarea Perioadei de Licitație
...
16C declarațiilor anulate, orice jucător care a pasat peste rând fiind vinovat.'
WHERE number = '17';

UPDATE rules SET
  text_de = 'A. Korrekte Form
Ein Gebot bezeichnet eine Anzahl Stiche über sechs, von eins bis sieben, und eine
Denomination. (Pass, Kontra und Rekontra sind Ansagen, aber keine Gebote.)
...
irgendeiner Denomination.

C. genügendes Gebot
Ein Gebot ist genügend, wenn es das letztvorangegangene überbietet.

D. ungenügendes Gebot
Ein Gebot, das das letztvorangegangene nicht überbietet, ist ungenügend. Es ist ein
Regelverstoß, ein ungenügendes Gebot abzugeben (zur Korrektur siehe Regel 27).

E. Rangordnung der Denominationen
Der Rang der Denominationen in absteigender Reihenfolge ist: Ohne, Pik, Herz, Karo, Treff.

F. andere Methoden
Ein Zuständiger Verband kann andere Methoden zulassen, Ansagen zu machen.',
  text_ro = 'A. Forma Corectă

Un anunţ specifică un număr de levate între 1 şi 7 (levate în plus faţă de 6) şi o
denominaţie. (Pas, contra și recontra sunt declaraţii dar nu anunţuri).
...
levate în orice denominaţie.

C. Anunț Suficient

Un anunţ care succede regulamentar ultimul anunţ precedent se numeşte suficient.

D. Anunț Insuficient
Un anunț care nu succede regulamentar ultimul anunţ precedent este insuficient.
Este o infracțiune să faci un anunț insuficient (vezi Legea 27 pentru rectificare).

E. Rangul Denominațiilor

Rangul denominaţiilor în ordine descrescătoare este: fără atu, pică, cupă, caro, treflă.

F. Alte Metode

Autoritățile Regulatoare pot autoriza alte metode de a efectua declarații.'
WHERE number = '18';
...
kontriert hat. (Regel 16 – Unerlaubte Information – kann anzuwenden sein.)
...
Denomination falsch nennt, wird angenommen, dass er das tatsächlich gemachte Gebot
rekontriert hat. (Regel 16 – Unerlaubte Information – kann anzuwenden sein.)

C. Kontra und Rekontra erloschen
Jedes Kontra oder Rekontra erlischt durch ein nachfolgendes regelkonformes Gebot.

D. Berechnung des Ergebnisses
Wenn nach einem kontrierten oder rekontrierten Gebot nicht ein regelkonformes Gebot
abgegeben wird, erhöht sich Punktezuteilung für das Ergebnis gemäß Regel 77.',
  text_ro = 'A. Contre
...
(Se poate aplica Legea 16 pentru informaţii neautorizate.)
...
făcut. (Se poate aplica Legea 16 pentru informaţii neautorizate.)

C. După Contra sau Recontra

După contra sau recontra poate urma orice anunţ regulamentar.

D. Calcularea Scorului unui Contract Contrat sau Recontrat

Dacă un anunţ contrat sau recontrat nu este urmat de niciun anunţ regulamentar,
valoarea scorului creşte aşa cum prevede Legea 77.'
WHERE number = '19';

UPDATE rules SET
  text_de = 'A. Ansage (akustisch) nicht gut verstanden
Ein Spieler kann unverzüglich Aufklärung verlangen, wenn er sich nicht sicher ist, welche
Ansage gemacht worden ist.

B. Wiederholung der Lizitation während der Lizitationsphase
...
Wiederholung verlangen, noch die Wiederholung vorzeitig abbrechen.

C. Wiederholung der Lizitation nach dem abschließenden Pass
...
eines Gegners gegründet hat, siehe Regel 21 bzw. 47E.

G. Regelwidriges Vorgehen
...
Spiels ansehen [siehe aber Regel 40B2(b)].',
  text_ro = 'A. Declarație Neidentificată Clar

Un jucător poate cere o clarificare imediată dacă nu este sigur ce declaraţie a fost
făcută.

B. Recapitularea Licitației în Timpul Perioadei de Licitație
...
recapitularea înainte ca aceasta să se fi terminat.

C. Recapitulare după Pas-ul Final
...
D. Cine Poate Recapitula Licitația

Cererii de recapitulare a licitaţiei i se va răspunde doar de către un adversar.

E. Corectarea Erorilor în Recapitulare
...
când o recapitulare incorectă produce prejudiciu).

F. Explicarea Declarațiilor
...
primită de la un adversar, vezi, după caz, Legea 21 sau Legea 47E.

G. Procedură Incorectă
...
sau de joc [dar vezi Legea 40B2b)].'
WHERE number = '20';

UPDATE rules SET
  text_de = 'A. eigenes Missverständnis
Einem Spieler, der auf Basis seines eigenen Missverständnisses etwas tut, steht keine
Korrektur und keine Entschädigung zu.

B. Ansage nach falscher Auskunft
...
Berichtigtes Ergebnis zu.',
  text_ro = 'A. Declarație sau Joc Bazat pe Propria Înțelegere Greșită
Nu se cuvine nicio rectificare sau compensație unui jucător care acționează bazat pe
propria sa înțelegere greșită.

B. Declarație Bazată pe Dezinformare de către un Adversar
...
UPDATE rules SET
  text_de = 'Die Lizitation endet, wenn:

A. wenigstens ein Spieler geboten hat, und auf das letzte Gebot dreimal in der Reihe gepasst
worden ist. Das letzte Gebot wird zum Kontrakt (siehe aber Regel 19D).

B. alle vier Spieler gepasst haben (siehe aber Regel 25). Die Blätter werden ohne Spiel ins
Board zurückgesteckt. Es darf nicht neu geteilt werden.',
  text_ro = 'Licitația se termină când:

A. După ce unul sau mai mulţi jucători au făcut anunţuri, după ultimul anunț
există 3 pas-uri consecutive în rotaţie. Ultimul anunţ devine contractul (dar
vezi legea 19D).

B. Toți cei 4 jucători pasează (dar vezi Legea 25). Mâinile sunt reintroduse în etui

fără joc. Nu se vor redistribui cărţile.'
WHERE number = '22';

UPDATE rules SET
  text_de = 'A. Definition
...
zurückgezogenen Ansage beizulegen ist.
...
anzuwenden, siehe aber unten 23C.

C. nicht-schuldige Seite geschädigt
...
jocul continuă fără alte rectificări. Nu se aplică Legea 16C2, dar vezi C mai jos.

C. Axa Nevinovată este Prejudiciată
...
UPDATE rules SET
  text_de = 'AUSGESPIELTE KARTE

Wenn der Turnierleiter feststellt, dass die Bildseite einer oder mehrerer Karten eines Spielers
aus dessen eigener Schuld für seinen Partner hätte sichtbar sein können, muss er anordnen,
dass jede derartige Karte bis zum Ende der Lizitation aufgedeckt auf dem Tisch liegen bleiben
soll. Die Information aus solchen aufgedeckten Karten ist für die nicht-schuldige Seite erlaubt
und für die schuldige Seite unerlaubt (siehe Regel 16C).

A. kleine Karte, die nicht vorzeitig ausgespielt worden ist
Wenn es sich um eine einzelne kleine Karte handelt, die nicht vorzeitig ausgespielt worden
ist, gibt es keine weitere Korrektur (siehe aber unten Punkt E.).
...
(siehe Regel 72C, wenn der Pass die nicht-schuldige Seite schädigt).
C. zwei oder mehr sichtbare Karten
...
die nicht-schuldige Seite schädigt).

D. Alleinspieler oder Strohmann
Wenn der schuldige Spieler Alleinspieler oder Strohmann wird, werden die Karten wieder ins
Blatt zurückgenommen.

E. Gegenspieler
Wenn am Ende des Lizits der schuldige Spieler ein Gegenspieler wird, wird jede aufgedeckte
Karte zur Strafkarte (siehe Regeln 50 und 51).',
  text_ro = 'Când arbitrul determină că, în timpul licitaţiei, din vina unui jucător, una sau mai
multe cărţi ale acestuia au fost în poziția de a putea fi văzute de partenerul său,
arbitrul va cere ca fiecare asemenea carte să fie lăsată pe masă, cu faţa în sus, până
la terminarea licitaţiei. Informaţia provenind din cărţi expuse astfel este autorizată
pentru partea nevinovată dar neautorizată pentru partea vinovată (vezi Legea 16C).

A. Carte Mică Neatacată Prematur

Dacă este vorba de o singură carte de rang inferior unui onor şi care nu a fost
atacată prematur, nu există altă rectificare (dar vezi E mai jos).

B. Onor sau Carte Atacată Prematur
...
(când pas-ul prejudiciază axa nevinovată, vezi Legea 72C).

C. Două sau Mai Multe Cărți Expuse
...
Ansage ist für seine Seite erlaubte, für seine Gegner unerlaubte Information.
...
3. Regel 16C ist auf alle zurückgezogenen oder gestrichenen Ansagen anzuwenden.',
  text_ro = 'A. Declarație Neintenționată
...
autorizată pentru axa sa și neautorizată pentru adversari.

B. Declarație Intenționată
...
3. Se aplică Legea 16C oricărei declarații retrase sau anulate.'
WHERE number = '25';

UPDATE rules SET
  text_de = 'A. keine Ausspielbeschränkungen
...
Ausspielbeschränkungen. Regel 16C ist nicht anzuwenden, siehe aber Regel 23C.

B. Ausspielbeschränkungen
...
pentru axa sa. Nu se aplică Legea 16C, dar vezi Legea 23C.
B. Restricții de Atac
...
jucătorului vinovat reţine mâna.'
WHERE number = '26';

UPDATE rules SET
  text_de = 'A. angenommen
...
Turnierleiter wendet die entsprechende Bestimmung dieser Regel auf die Ersatzansage an.
...
wahrscheinliche Ergebnis auf dem Board zu rekonstruieren.',
  text_ro = 'A. Anunț Insuficient Acceptat
...
2. Dacă un jucător face un anunţ insuficient peste rând se aplică Legea 31.

B. Anunț Insuficient Neacceptat
...
nu acceptă noul anunţ insuficient conform paragrafului A1.

C. Înlocuire Prematură
...
relevantă a acestei legi declarației înlocuitoare.

D. Axa Nevinovată este Prejudiciată
...
probabil al donei în cazul în care anunțul insuficient nu s-ar fi produs.'
WHERE number = '27';

UPDATE rules SET
  text_de = 'A. rechter Gegner auf Pass gesetzt
Eine Ansage gilt als in der Reihe abgegeben, wenn der rechte Gegner an der Reihe ist
anzusagen und dieser auf Pass gesetzt ist.

B. Der Spieler, der an der Reihe ist, sagt an
...
ist nicht anzuwenden, siehe aber Regel 16C2.',
  text_ro = 'A. Adversarul din Dreapta este Obligat să Paseze

O declarație se consideră a fi la rând când este făcută de un jucător la rândul
adversarului său din dreapta, dacă acel adversar este obligat de lege să paseze.

B. Declarație a Jucătorului Corect care Anulează o Declarație Peste Rând
...
respectiv. Nu se aplică Legea 26, dar vezi Legea 16C2.'
WHERE number = '28';

UPDATE rules SET
  text_de = 'A. Verlust des Anspruchs auf Korrektur
Nach einer Ansage außer der Reihe kann sich der linke Gegner des schuldigen Spielers
entscheiden anzusagen; der Anspruch auf jedwede Korrektur geht damit verloren.

B. Ansage außer der Reihe gestrichen
...
Bestimmungen der Regeln 30, 31 oder 32.

C. künstliche Ansage außer der Reihe
...
Denomination(en) anzuwenden.',
  text_ro = 'A. Pierderea Dreptului la Rectificare

După o declaraţie peste rând, adversarul din stânga al jucătorului vinovat poate alege
să declare, pierzând astfel dreptul la orice rectificare.

B. Declarație Peste Rând Anulată
...
C. Declarația Peste Rând Este Artificială

Dacă o declaraţie peste rând este artificială, prevederile Legilor 30, 31 sau 32 se
aplică denominației (denominaţiilor) specficate, nu celei numite.'
WHERE number = '29';

UPDATE rules SET
  text_de = 'Wenn ein Pass außer der Reihe gestrichen worden ist (weil ihn der Gegner nicht angenommen
hat – siehe Regel 29A), dann gilt:

A. wenn der rechte Gegner an der Reihe war anzusagen
...
Reihe ist anzusagen; Regel 72C kann anzuwenden sein.

B. wenn der Partner oder der linke Gegner an der Reihe war anzusagen
...
nicht Regel 30, sondern Regel 31 anzuwenden.',
  text_ro = 'Când un jucător a pasat peste rând şi declaraţia este anulată, opţiunea din Legea
29A nefiind exercitată, se aplică următoarele prevederi (dacă pasul este artificial vezi
C):
...
din stânga este tratat ca o schimbare de declarație. Se aplică Legea 25.

C. Când Pas-ul Este Artificial

Când un pas peste rând este artificial sau este pas al unei declaraţii artificiale a
partenerului se aplică Legea 31, nu Legea 30.'
WHERE number = '30';

UPDATE rules SET
  text_de = 'Ein Kontra oder Rekontra außer der Reihe (ausgenommen ein unzulässiges Kontra oder
Rekontra, siehe Regel 36) kann vom nächsten Gegner hinter dem schuldigen Spieler
angenommen werden (siehe Regel 29A). Andernfalls gilt:
...
anzusagen, und der Turnierleiter entscheidet nach Absatz A2(a) bzw. A2(b).

C. linker Gegner an der Reihe
Spätere Ansagen, wenn der linke Gegner an der Reihe ist anzusagen, gelten als Änderung
einer Ansage, auf die Regel 25 anzuwenden ist.',
  text_ro = 'O contra sau o recontra peste rând poate fi acceptată de către adversarul din stânga
jucătorului vinovat (vezi Legea 29A), exceptând o contra sau o recontra inadmisibilă
(vezi Legea 36), care nu se poate accepta niciodată. Dacă declarația peste rând nu
este acceptată, ea este anulată și:
...
procedează ca la punctele A2a) sau A2b) de mai sus.

C. Declarații Ulterioare la Rândul Adversarului din Stânga

Declarațiile ulterioare făcute la rândul adversarului din stânga sunt tratate ca
schimbări de declarație și se aplică Legea 25.'
WHERE number = '32';

UPDATE rules SET
  text_de = 'Eine Ansage, die gleichzeitig mit der des Spielers, der an der Reihe war anzusagen, gemacht
wird, gilt als nachfolgend.',
  text_ro = 'O declaraţie făcută simultan cu una a jucătorului care era la rând se consideră a fi o
declaraţie subsecventă.'
WHERE number = '33';

UPDATE rules SET
  text_de = 'Wenn nach einer Ansage drei oder mehrere aufeinanderfolgende Pass abgegeben worden
sind, wobei wenigstens einer außer der Reihe war, ist Regel 17D3 anzuwenden.',
  text_ro = 'Când o declaraţie este urmată de 3 pas-uri consecutive, dintre care unul sau mai
multe peste rând, se aplică Legea 17D3.'
WHERE number = '34';

UPDATE rules SET
  text_de = 'Folgende Ansagen sind unzulässig:

A. Ein Kontra oder Rekontra, das gegen Regel 19 verstößt. Regel 36 ist anzuwenden.

B. Ein Gebot, Kontra oder Rekontra eines Spielers, der auf Pass gesetzt ist. Regel 37 ist
anzuwenden.

C. Ein Gebot von mehr als sieben. Regel 38 ist anzuwenden.

D. Eine Ansage nach dem abschließenden Pass. Regel 39 ist anzuwenden.',
  text_ro = 'Următoarele declarații sunt inadmisibile:

A. O contra sau o recontra nepermisă de Legea 19. Se aplică Legea 36.

B. Un anunț, o contra sau o recontra aparținând unui jucător obligat să paseze. Se

aplică Legea 37.

C. Un anunț peste palierul de 7. Se aplică Legea 38.

D. O declarație după pas-ul final al licitației. Se aplică Legea 39.'
WHERE number = '35';

UPDATE rules SET
  text_de = 'A. linker Gegner sagt vor der Korrektur an
...
nicht anzuwenden.
B. linker Gegner sagt nicht vor der Korrektur an
...
C. Regelwidrigkeit erst nach der Lizitationsphase bemerkt
...
unzulässige Ansage nicht gegeben hätte.',
  text_ro = 'A. Adversarul din Stânga Jucătorului Vinovat Declară Înainte de Rectificare
...
fi produs nicio neregularitate. Nu se aplică restricţiile de atac din Legea 26B.

B. Adversarul din Stânga Jucătorului Vinovat Nu Declară Înainte de Rectificare
...
72C. Se pot aplica restricţiile de atac din Legea 26B.

C. Neregularitate Descoperită După Perioada de Licitație
...
Die Ausspielbeschränkungen von Regel 26B sind nicht anzuwenden.
...
Ausspielbeschränkungen nach Regel 26B können anzuwenden sein.',
  text_ro = 'A. Adversarul din Stânga Jucătorului Vinovat Declară Înainte de Rectificare
...
UPDATE rules SET
  text_de = 'A. Spiel unzulässig
Ein Kontrakt von mehr als sieben kann nie gespielt werden.

B. Gebot und nachfolgende Ansagen gestrichen
Ein Gebot von mehr als sieben wird gestrichen, ebenso alle nachfolgenden Ansagen.
C. schuldige Seite muss passen
...
Korrektur angesagt hat.',
  text_ro = 'A. Joc Nepermis

Nu se poate niciodată juca un contract peste palierul de 7.

B. Anunț și Declarații Subsecvente Anulate

Un anunț peste palierul de 7 este anulat împreună cu toate declarațiile subsecvente.

C. Axa Vinovată Trebuie să Paseze

Declarația înlocuitoare este pas; licitația continuă dacă nu s-a încheiat deja, și ambii
jucători ai axei vinovate trebuie să paseze ori de câte ori le vine rândul să declare.

D. Posibilitatea de a Aplica Legile 26B și 72C
...
rectificarea acesteia, caz în care nu se mai face recurs la aceste Legi.'
WHERE number = '38';

UPDATE rules SET
  text_de = 'A. Ansagen gestrichen
Alle Ansagen nach dem abschließenden Pass sind gestrichen.

B. Pass eines Gegenspielers oder Ansage der Seite des Alleinspielers
...
Alleinspielers oder Strohmanns ist, gibt es keine weitere Korrektur.

C. andere Aktion eines Gegenspielers
...
Ausspielbeschränkungen von Regel 26B anzuwenden sein.',
  text_ro = 'A. Declarații Anulate

Toate declaraţiile făcute după pas-ul final al licitaţiei sunt anulate.

B. Pas al unui Apărător sau Orice Declarație a Declarantului sau Mortului
...
declaraţie a viitorului declarant sau mort, nu există nicio altă rectificare.

C. Altă Acțiune a unui Apărător
...
aplica restricțiile de atac din Legea 26B.'
WHERE number = '39';

UPDATE rules SET
  text_de = 'A. Systemabmachungen der Spieler
...
ein, sondern nur die Methode.)
B. Besondere Partnerschaftsvereinbarungen
...
C. Abweichungen vom System und Bluffs
...
für seine Spieltechnik verwenden',
  text_ro = 'A. Înțelegeri Sistemice
...
B. Înțelegeri Speciale Între Parteneri
...
pentru alegerea unei acţiuni de către un adversar, care este astfel prejudiciat.

C. Deviere de la Sistem și Declarații Psihice
...
adversarilor faptul că el s-a abătut de la metodele anunțate.'
WHERE number = '40';

UPDATE rules SET
  text_de = 'A. verdecktes erstes Ausspiel
...
Blatt des Gegenspielers aufgenommen.

B. Wiederholung der Lizitation und Fragen
...
zwar jeder, wenn er zu spielen an der Reihe ist41.3.

C. erstes Ausspiel aufgedeckt
...
wem, er allenfalls kontriert oder rekontriert worden ist.

D. Strohmann wird aufgedeckt
...
Strohmanns.',
  text_ro = 'A. Atac cu Cartea pe Spate
...
(vezi Legile 47E și 54); cartea retrasă trebuie reîncadrată în mâna apărătorului.

B. Recapitularea Licitației și Întrebări
...
jocului, fiecare la rândul său11 de a juca.

C. Întoarcerea pe Față a Cărții de Atac
...
cât şi pe cele din mâna mortului.'
WHERE number = '41';

UPDATE rules SET
  text_de = 'A. absolute Rechte
...
der Reihe ist, aus der Hand zu spielen.
B. bedingte Rechte
...
3. Er darf nach Ende des Spiels die Aufmerksamkeit auf eine Regelwidrigkeit lenken.',
  text_ro = 'A. Drepturi Absolute
...
se asigură că mortul dă la culoare (vezi Legea 45F pentru joc sugerat de mort).

B. Drepturi Condiționate
...
UPDATE rules SET
  text_de = 'A. Beschränkungen des Strohmanns
...
3. Ein Gegenspieler darf dem Strohmann nicht sein Blatt zeigen.
...
Alleinspielers behält das Tischergebnis.',
  text_ro = 'Exceptând ceea ce Legea 42 permite:

A. Limitări ale Drepturilor Mortului
...
3. Un apărător nu are voie să-și arate mâna către mort.

B. Limitări Încălcate
...
rămâne valabil scorul obținut la masă.'
WHERE number = '43';

UPDATE rules SET
  text_de = 'A. Ausspiel zu einem Stich
Der Spieler, der zu einem Stich ausspielt, kann jede Karte in seinem Blatt ausspielen (wenn er
nicht einer Beschränkung nach einem Regelverstoß seiner Seite unterliegt).
...
Diese Verpflichtung hat Vorrang vor allen anderen Verpflichtungen nach diesen Regeln.
...
Beschränkung nach einem Regelverstoß seiner Seite unterliegt).
...
Karte der ausgespielten Farbe gespielt hat.

G. Ausspiel zu Stichen nach dem ersten
Zum nächsten Stich wird aus dem Blatt ausgespielt, das den vorherigen gewonnen hat.',
  text_ro = 'A. Atac în Cadrul unei Levate

Jucătorul care atacă în cadrul unei levate poate să joace orice carte pe care o are în
mână (mai puțin dacă are restricţii din cauza unei neregularităţi a axei sale).

B. Jocuri Subsecvente la o Levată
...
levatelor vezi Legile 45, respectiv 65.)

C. Obligația de a Da la Culoare

Fiecare jucător care joacă la o levată trebuie să dea la culoare, dacă este posibil.
Această obligaţie are prioritate față de toate celelalte cerințe ale acestor legi.

D. Inabilitatea de a Da la Culoare

Dacă un jucător nu poate da la culoare, el poate să joace orice carte (mai puțin dacă
are restricţii din cauza unei neregularităţi a axei sale).

E. Levate care Conțin Atuuri

O levată care conține cel puțin un atu este câștigată de jucătorul care a furnizat atuul
cel mai mare.

F. Levate care Nu Conțin Atuuri

O levată care nu conţine atuuri este câştigată de jucătorul care a furnizat cartea cea
mai mare în culoarea atacată.

G. Atac la Levatele Subsecvente

Atacul la levata următoare se face din mâna jucătorului care a câştigat ultima levată.'
WHERE number = '44';

UPDATE rules SET
  text_de = 'A. Spiel einer Karte aus einem Blatt
Jeder Spieler außer dem Strohmann spielt eine Karte, indem er sie aus seinem Blatt nimmt
und sie mit der Bildseite nach oben45.1 unmittelbar vor sich auf den Tisch legt.

B. Spiel einer Karte des Strohmanns
...
45.1 Das erste Ausspiel erfolgt verdeckt, wenn der Zuständige Verband nichts anders anordnet.
C. Karte gilt als gespielt
...
5. Eine (große oder kleine) Strafkarte kann gespielt werden müssen (siehe Regel 50).

D. Strohmann nimmt eine nicht genannte Karte
...
begangen hat, siehe Regel 64B3 und 64C.
E. fünfte Karte eines Stichs
...
nach dem Urteil des Turnierleiters ausgespielt worden ist und daher Regel 55 anzuwenden ist.

F. Strohmann bezeichnet eine Karte
...
ein Spiel nahegelegt hat und die Gegenspieler durch dieses geschädigt worden sind.

G. Umdrehen der Karten
Kein Spieler soll seine Karte umdrehen, bevor alle vier Spieler zum Stich gespielt haben.',
  text_ro = 'A. Jocul unei Cărți din Mână

Fiecare jucător, exceptând mortul, joacă o carte detaşând-o din mâna sa şi aşezând-
o în dreptul lui pe masă, cu faţa în sus12.

B. Jocul unei Cărți de la Mort
...
să-și ia singur cartea dorită.

C. Carte Considerată Jucată
...
5. O carte penalizată, majoră sau minoră, ar putea trebui jucată (vezi Legea 50).

D. Mortul Joacă o Carte pe care Declarantul Nu a Cerut-o
...
levată deja începută și reprezintă o renonsă de la mort, vezi Legile 64B3 și 64C.

E. A Cincea Carte Jucată la o Levată
...
arbitrul consideră că a fost atacată, caz în care se aplică Legea 55.

F. Mortul Indică o Carte
...
adversarii au fost prejudiciaţi de jocul sugerat.

G. Întoarcerea pe Spate a Cărților

Niciun jucător n-ar trebui să-și întoarcă propria carte pe spate înainte ca toţi cei patru
jucători să fi jucat la levata respectivă.'
WHERE number = '45';

UPDATE rules SET
  text_de = 'EINER KARTE DES STROHMANNS

A. korrekte Form
Wenn der Alleinspieler eine Karte des Strohmanns verlangt, hat er sowohl Farbe als auch
Rang klar zu nennen.

B. unvollständige oder ungültige Bezeichnung
...
Karte vom Strohmann zu spielen ist.',
  text_ro = 'DE LA MORT

A. Modul Corect de a Desemna o Carte a Mortului

Când cere jucarea unei cărți de la mort, declarantul ar trebui să precizeze clar atât
culoarea cât și rangul cărții dorite.

B. Desemnare Incompletă sau Invalidă
...
cartea jucată de la mort.'
WHERE number = '46';

UPDATE rules SET
  text_de = 'A. Im Zuge einer Korrektur
...
Strafkarte werden, siehe Regel 50.)

B. Korrektur eines regelwidrigen Spiels
...
Regel 49 – Strafkarte). Für gleichzeitiges Spiel siehe Regel 58.

C. Änderung einer unbeabsichtigten Bezeichnung
Eine bereits gespielte Karte kann nach einer Änderung einer Bezeichnung gemäß Regel
45C4(b) zurückgenommen und ohne weitere Korrektur dem Blatt wieder hinzugefügt werden.

D. Gegner hat sein Spiel geändert
...
und 62C2 können anzuwenden sein.)

E. Änderung wegen falscher Auskunft
...
nicht zurückgenommen werden.',
  text_ro = 'A. În Cursul unei Rectificări

O carte jucată poate fi retrasă când rectificarea unei neregularități o cere (dar cartea
retrasă de un apărător poate deveni carte penalizată, vezi Legea 49).

B. Pentru a Corecta un Joc Ilegal
...
simultan, vezi Legea 58.

C. Pentru a Schimba o Desemnare Neintenționată

O carte jucată poate fi retrasă şi reîncadrată în mână fără altă rectificare după o
schimbare de desemnare permisă de Legea 45C4b).

D. După o Carte Înlocuită de un Adversar
...
E. Carte Înlocuită După o Dezinformare
...
2. Exceptând situaţiile prevăzute în această Lege, o carte jucată nu poate fi retrasă.'
WHERE number = '47';

UPDATE rules SET
  text_de = 'A. Karte des Alleinspielers wird sichtbar
...
B. Alleinspieler deckt Karten auf
...
nicht seine Absicht), und Regel 68 ist dann anzuwenden.',
  text_ro = 'A. Declarantul Expune o Carte
...
penalizată. Declarantul nu este obligat să joace o carte scăpată accidental din mână.

B. Declarantul își Arată Cărțile
...
UPDATE rules SET
  text_de = 'Wenn, abgesehen vom normalen Spielverlauf oder der Anwendung der Regeln, eine Karte
...
wenn ein Gegenspieler einem Verzicht seines Partners widerspricht.',
  text_ro = 'Exceptând în cursul normal al jocului sau al aplicării legilor (vezi, de exemplu, Legea
...
obiectează la concesia făcută de un apărător.'
WHERE number = '49';

UPDATE rules SET
  text_de = 'Eine vorzeitig aufgedeckte (nicht aber ausgespielte – siehe Regel 57) Karte eines
Gegenspielers ist eine Strafkarte, wenn der Turnierleiter nichts anderes entscheidet (siehe
Regel 49, und Regel 72C kann anzuwenden sein).

A. eine Strafkarte bleibt aufgedeckt
Eine Strafkarte muss mit der Bildseite nach oben unmittelbar vor dem Spieler, dem sie gehört,
auf dem Tisch liegen bleiben, bis eine Korrektur gewählt worden ist.

B. große oder kleine Strafkarte
...
Strafkarten.
C. Vorgehen bei einer kleinen Strafkarte
...
spielen. Sein Partner unterliegt keinen Ausspielbeschränkungen, siehe aber unten Punkt E.

D. Vorgehen bei einer großen Strafkarte
...
E. Information aus einer Strafkarte
...
rekonstruieren.',
  text_ro = 'O carte expusă prematur (dar nu atacată, vezi Legea 57) de către un apărător este
carte penalizată dacă arbitrul nu hotărăşte altfel (vezi Legea 49 şi se poate aplica
Legea 72C).

A. Cartea Penalizată Rămâne Expusă

O carte penalizată trebuie să rămână expusă pe masă, în faţa jucătorului căruia îi
aparţine, până când a fost aleasă o rectificare.

B. Carte Penalizată Majoră sau Minoră
...
devin cărţi penalizate majore.

C. Utilizarea unei Cărți Penalizate Minore
...
D. Utilizarea unei Cărți Penalizate Majore
...
cartea rămâne penalizată.

E. Informația Provenită dintr-o Carte Penalizată
...
rezultatul probabil al donei în lipsa efectului cărții sau cărților penalizate.'
WHERE number = '50';

UPDATE rules SET
  text_de = 'A. schuldiger Spieler an der Reihe
...
Karte zu diesem Stich gespielt werden soll.

B. Partner des schuldigen Spielers an der Reihe
...
anzuwenden, solange die Strafkarten bleiben.',
  text_ro = 'A. La Rândul Jucătorului Vinovat

Dacă, la rândul său de a juca, un apărător are două sau mai multe cărţi penalizate
care pot fi jucate legal, declarantul desemnează care din ele trebuie jucată.

B. La Rândul de a Ataca al Partenerului Jucătorului Vinovat
...
și 51 continuă să se aplice atât timp cât rămân cărți penalizate.'
WHERE number = '51';

UPDATE rules SET
  text_de = 'A. Gegenspieler spielt eine Strafkarte nicht
...
gespielt hat, zurücknehmen.

B. Gegenspieler spielt statt dessen eine andere Karte
...
regelwidrig gespielte Karte des Gegenspielers wird zur großen Strafkarte.',
  text_ro = 'A. Apărătorul Omite să Joace o Carte Penalizată

Când un jucător omite să atace sau să joace o carte penalizată conform cerințelor
Legilor 50 și 51, el nu poate să-și retragă din proprie inițiativă o altă carte jucată.

B. Apărătorul Joacă o Altă Carte
...
apărător în cursul neregularității devine carte penalizată majoră.'
WHERE number = '52';

UPDATE rules SET
  text_de = 'A. Ausspiel außer der Reihe als korrekt behandelt
...
ausgespielt werde (und siehe Regel 47B).

B. Korrektes Ausspiel nach dem regelwidrigen
...
Stich.
53.1 Ein Ausspiel außer der Reihe zum 13. Stich muss zurückgenommen werden.
C. Falscher Gegenspieler spielt zum regelwidrigen Ausspiel des Alleinspielers
...
Ausspiel und Regel 57 ist anzuwenden.',
  text_ro = 'A. Atac Peste Rând Tratat ca Atac Corect
...
va cere ca atacul să se facă din mâna corectă (şi vezi Legea 47B).

B. Atac Corect Ulterior Atacului Neregulamentar
...
jucate eronat la această levată pot fi retrase, dar se aplică Legea 16C.

C. Apărătorul Greșit Joacă la Atacul Neregulamentar al Declarantului
...
UPDATE rules SET
  text_de = 'Wenn ein erstes Ausspiel außer der Reihe aufgedeckt ist, während der Partner des schuldigen
Spielers verdeckt ausspielt, lässt der Turnierleiter das verdeckte Ausspiel zurückgehen.

Außerdem gilt:

A. der Alleinspieler deckt sein Blatt auf
...
wird zum Alleinspieler.

B. der Alleinspieler nimmt das Ausspiel an
...
zurückgenommen werden, um eine Revoke zu berichtigen.

C. der Alleinspieler muss das Ausspiel annehmen
...
Ausspiel annehmen, und der vermutete Alleinspieler wird zum Alleinspieler.

D. der Alleinspieler lehnt das Ausspiel ab
...
E. erstes Ausspiel von der falschen Seite
Wenn ein Spieler der Seite des Alleinspielers zum ersten Stich auszuspielen versucht, wird
Regel 24 angewandt.',
  text_ro = 'Când un atac iniţial peste rând este făcut cu cartea pe faţă și partenerul jucătorului
vinovat atacă cu cartea pe spate, arbitrul cere ca atacul pe spate să fie retras şi:

A. Declarantul își Etalează Mâna
...
una sau mai multe cărţi, el trebuie să-şi etaleze toată mâna. Mortul devine declarant.

B. Declarantul Acceptă Atacul
...
retrasă decât pentru a corecta o renonsă.

C. Declarantul Trebuie să Accepte Atacul
...
24), el trebuie să accepte atacul și presupusul declarant devine declarant.

D. Declarantul Refuză Atacul

Declarantul îi poate cere unui apărător să-şi retragă atacul iniţial peste rând făcut cu
cartea pe faţă. Cartea retrasă devine carte penalizată majoră şi se aplică Legea 50D.

E. Atac Inițial al Axei Greșite

Dacă declarantul sau mortul încearcă să facă un atac iniţial, se aplică Legea 24.'
WHERE number = '54';

UPDATE rules SET
  text_de = 'A. Ausspiel angenommen
...
Entscheidung des Spielers, der nach dem regelwidrigen Ausspiel zu spielen an der Reihe ist.

B. der Alleinspieler muss das Ausspiel zurücknehmen
...
spielt vom richtigen Blatt aus.

C. Alleinspieler könnte Information erhalten haben
Wenn der Alleinspieler eine Spieldurchführung wählt, die sich auf eine Information stützen
könnte, die er durch seinen Regelverstoß erhalten hat, ist Regel 16 anzuwenden.',
  text_ro = 'A. Atac Acceptat
...
urmează la rând după atacul neregulamentar.

B. Declarantul Trebuie să-și Retragă Atacul
...
retrage cartea atacată eronat și trebuie să atace din mâna corectă.

C. Declarantul Ar Putea Obține Informații

Când declarantul adoptă o linie de joc care ar fi putut fi bazată pe o informaţie
obținută prin intermediul infracţiunii sale, se aplică Legea 16.'
WHERE number = '55';

UPDATE rules SET
  text_de = 'Wenn ein Ausspiel außer der Reihe aufgedeckt wird, kann der Alleinspieler

A. das regelwidrige Ausspiel annehmen (Regel 53), oder

B. verlangen, dass der Gegenspieler sein aufgedecktes Ausspiel außer der Reihe
zurücknimmt. Die ausgespielte Karte wird zur großen Strafkarte und Regel 50 wird
angewandt.',
  text_ro = 'Când un apărător atacă peste rând cu cartea pe față, declarantul poate:

A. Să accepte atacul neregulamentar conform Legii 53, sau
B. Să îi ceară apărătorului să-și retragă atacul peste rând. Cartea retrasă devine

carte penalizată majoră și se aplică Legea 50D.'
WHERE number = '56';

UPDATE rules SET
  text_de = 'A. vorzeitiges Ausspiel oder Spiel zum nächsten Stich
...
festzulegenden, Farbe verbieten.
B. Partner des schuldigen Spielers kann die Korrekturverpflichtung nicht erfüllen
Wenn der Partner des schuldigen Spielers der vom Alleinspieler gewählten Korrektur (siehe
oben Punkt A.) nicht Folge leisten kann, kann er gemäß Regel 59 eine beliebige Karte spielen.

C. wenn der Alleinspieler oder Strohmann gespielt hat
...
ist eine gespielte Karte und darf nicht zurückgenommen werden, wenn sie zulässig ist.

D. Vorzeitiges Spiel, wenn der rechte Gegner an der Reihe ist
...
Spieler sie spielen, wenn er an der Reihe ist; andernfalls wird sie eine große Strafkarte.',
  text_ro = 'A. Joc Prematur sau Atac Prematur la Levata Următoare
...
specificată de declarant.

B. Partenerul Jucătorului Vinovat Nu Se Poate Conforma Rectificării

Când partenerul jucătorului vinovat nu se poate conforma rectificării alese de
declarant el poate juca orice carte, conform Legii 59.

C. Declarantul sau Mortul a Jucat
...
jucată care, dacă este legală, nu poate fi retrasă.

D. Joc Prematur la Rândul Adversarului din Dreapta
...
18 Ca printr-un gest sau o încuviințare'
WHERE number = '57';

UPDATE rules SET
  text_de = 'A. gleichzeitiges Spiel von zwei Spielern
Ein Ausspiel oder Spiel, das gleichzeitig mit dem regelkonformen Ausspiel oder Spiel eines
anderen Spielers erfolgt ist, gilt als nachfolgend.

B. gleichzeitige Karten aus einem Blatt
...
57.1 auch etwa durch eine Geste oder ein Nicken',
  text_ro = 'A. Jocuri Simultane a Doi Jucători

Un atac sau joc făcut simultan cu atacul sau jocul legal al altui jucător se consideră a
fi un atac sau joc consecutiv.

B. Cărți Jucate Simultan din Aceeași Mână
...
levata următoare, se aplică Legea 67.'
WHERE number = '58';

UPDATE rules SET
  text_de = 'Ein Spieler kann jede regelkonforme Karte spielen, wenn er nicht in der Lage ist, einer
...
oder weil er Farbe bekennen muss.',
  text_ro = 'Un jucător poate juca orice altă carte legală dacă nu poate să atace sau joace așa
...
pentru că este obligat să dea la culoare.'
WHERE number = '59';

UPDATE rules SET
  text_de = 'A. Spiel einer Karte nach einer Regelwidrigkeit
...
wenn der betreffende Spieler später wieder an der Reihe ist.

B. Gegenspieler spielt vor einem korrigierten Ausspiel des Alleinspielers
...
die Karte des Gegenspielers eine große Strafkarte (Regel 50).

C. Spiel der schuldigen Seite vor einer Korrektur
Ein Spiel eines Spielers der schuldigen Seite, bevor eine Korrektur angeordnet worden ist,
ändert nichts an den Rechten seiner Gegner, und kann selbst einer Korrektur unterliegen.',
  text_ro = 'A. Carte Jucată După o Neregularitate
...
B. Un Apărător Joacă Înainte de Atacul din Mâna Corectă Impus Declarantului
...
corectă, cartea apărătorului devine carte penalizată majoră (Legea 50).

C. Joc al Axei Vinovate Înainte de Deciderea unei Rectificări

Jocul unui membru al axei vinovate înainte de deciderea unei rectificări nu afectează
drepturile adversarilor, și poate face el însuşi obiectul unei rectificări.'
WHERE number = '60';

UPDATE rules SET
  text_de = 'FRAGE NACH EINER REVOKE

A. Definition der Revoke
...
verpflichtet war. (Wenn er dazu nicht in der Lage ist, siehe Regel 59.)

B. Recht, nach einer möglichen Revoke zu fragen
...
conforma vezi Legea 59.)

B. Dreptul de a Întreba despre o Posibilă Renonsă
...
crea informație neautorizată).

C. Dreptul de a Inspecta Levatele
...
UPDATE rules SET
  text_de = 'A. Revoke muss berichtigt werden
Ein Spieler muss unbedingt eine Revoke berichtigen, wenn die Aufmerksamkeit auf die
Regelwidrigkeit gelenkt wird, bevor sie etabliert ist.

B. Berichtigung einer Revoke
...
wenn es sich um eine aufgedeckte Karte eines Gegenspielers handelt.

C. Anschließend gespielte Karten
...
Jeder Karte, die die Gegenspieler zurückgenommen haben, wird zur Strafkarte.

D. Revoke im 12. Stich
...
hat, ist Regel 16C anzuwenden.',
  text_ro = 'A. Renonsa Trebuie Corectată

Un jucător trebuie să-şi corecteze renonsa dacă se atrage atenția asupra
neregularității înainte ca renonsa să fie consumată.

B. Corectarea unei Renonse
...
carte retrasă de apărători devine carte penalizată.

D. Renonsă la Levata a Douăsprezecea
...
rândul partenerului său să joace la acea levată, se aplică Legea 16C.'
WHERE number = '62';

UPDATE rules SET
  text_de = 'A. Revoke wird etabliert
...
Regel 62D oder 62C3), und der Stich, in dem sie vorgefallen ist, steht wie gespielt.',
  text_ro = 'A. Renonsa Devine Consumată
...
de a face o declarație pe dona următoare.

B. Renonsa Nu Poate Fi Corectată
...
care s-a petrecut renonsa rămâne așa cum s-a jucat.'
WHERE number = '63';

UPDATE rules SET
  text_de = 'A. automatischer Stichtransfer
...
wird am Ende des Spiels ein Stich an die nicht-schuldige Seite transferiert.

B. kein automatischer Stichtransfer
...
8. die Revoke gemäß Regel 62C3 berichtigt worden ist.
...
berichtigtes Ergebnis so zuweisen, als hätte keine Revoke stattgefunden.',
  text_ro = 'A. Ajustare Automată a Numărului de Levate
...
următoare, la sfârșitul jocului se transferă o levată axei nevinovate.

B. Nicio Ajustare Automată
...
8. Renonsa a fost corectată conform Legii 62C3.
...
ajustat bazat pe rezultatul probabil în absența tuturor renonselor.'
WHERE number = '64';

UPDATE rules SET
  text_de = 'A. fertig gespielter Stich
Wenn zu einem Stich vier Karten gespielt worden sind, legt jeder Spieler seine eigene Karte
mit der Bildseite nach unten bei sich auf den Tisch.

B. Stichbesitz verfolgen
...
die Karten gespielt worden sind.

D. Einvernehmen über das Tischergebnis
...
acest termen, se poate aplica Legea 16B.
...
care au fost jucate cărţile.

D. Acord Asupra Rezultatului Jocului
...
de a reclama (sau infirma) o renonsă.'
WHERE number = '65';

UPDATE rules SET
  text_de = 'A. aktueller Stich
...
wenn es erforderlich ist, um eine behauptete Revoke festzustellen).

D. nach Ende des Spiels
...
ihre Karten vermischt hat, muss der Turnierleiter zugunsten der anderen Seite entscheiden.',
  text_ro = 'A. Levata Curentă
...
toate cărţile jucate în acea levată să fie menţinute vizibile.

B. Ultima Carte Proprie
Până când axa lui a atacat sau jucat la levata următoare, declarantul sau orice
apărător poate să-și inspecteze, dar nu să-și expună, ultima carte jucată.

C. Levate Închise

Apoi, până la sfârșitul jocului, levatele închise nu mai pot fi inspectate (decât la
cererea explicită a arbitrului; de exemplu, pentru a verifica dacă s-a făcut o renonsă).

D. După Terminarea Jocului
...
amestecat cărțile, arbitrul decide în favoarea celeilalte axe.'
WHERE number = '66';

UPDATE rules SET
  text_de = 'A. bevor beide Seiten zum nächsten Stich gespielt haben
...
(gleichzeitiges Spiel) anzuwenden.
...
berichtigen.',
  text_ro = 'A. Înainte ca Ambele Axe să Joace la Levata Următoare
...
B. După ce Ambele Axe Joacă la Levata Următoare
...
la o levată ulterioară și este prea târziu pentru a corecta jocul ilegal.'
WHERE number = '67';

UPDATE rules SET
  text_de = 'Damit eine Aussage oder Handlung einen Claim oder Verzicht von Stichen unter diesen
Regeln darstellt, muss sie sich auf andere als den aktuellen Stich beziehen. Wenn sie sich nur
auf Gewinn oder Verlust des aktuellen Stiches beziehen, geht das Spiel normal weiter;
Karten, die ein Gegenspieler aufdeckt oder kundtut, werden keine Strafkarten, aber die Regeln
16 und 57A können anzuwenden sein.

A. Definition eines Claims
...
außer der Reihe seine Karten aufdeckt, ist Regel 54 und nicht 68 anzuwenden).

B. Definition eines Verzichts
...
der claimt oder verzichtet, deckt sein Blatt auf.

D. Spielunterbrechung
...
erzielte Ergebnis bleibt bestehen.',
  text_ro = 'Pentru ca o afirmație sau acțiune să constituie o revendicare sau concesie de levate
conform acestor Legi, ea trebuie să se refere la alte levate decât cea curentă. Dacă
afirmația sau acțiunea ține doar de câștigarea sau pierderea unei levate incomplete
în curs de desfășurare, jocul continuă normal; cărțile expuse sau dezvăluite de un
apărător nu devin cărți penalizate, dar se pot aplica Legile 16 și 57A.

A. Definiția Revendicării
...
reîncadrată în mâna unui apărător a fost expusă, aceasta devine carte penalizată (vezi Legea 50).
C. Clarificări Necesare
...
ordinea jucării cărților. Jucătorul care revendică sau concede își etalează mâna.

D. Întreruperea Jocului
...
UPDATE rules SET
  text_de = 'A. Zustimmung etabliert
...
im Spiel gewonnen oder verloren worden.

B. Zurücknahme einer etablierten Zustimmung
...
wobei ein solcher Stich seiner Seite zuerkannt wird.',
  text_ro = 'A. Stabilirea Acordului
...
câştigate sau pierdute jucând.

B. Retragerea unui Acord Stabilit
...
Scorul donei este reînregistrat cu o asemenea levată acordată axei sale.'
WHERE number = '69';

UPDATE rules SET
  text_de = 'A. allgemeines Ziel
...
gegen den Claimer zu entscheiden. Der Turnierleiter geht dabei wie unten beschrieben vor.

B. Spielerklärung wiederholt
...
3. durch irgendein normales70.1 Spiel dieses Atout einen Stich machen könnte.

D. Überlegungen des Turnierleiters
...
3. Arbitrul poate cere jucătorilor să își expună pe masă cărțile restante.

C. Există un Atu Afară
...
3. Acel atu poate câștiga o levată ca urmare a unui joc normal21 oarecare.

D. Considerațiile Arbitrului
...
UPDATE rules SET
  text_de = 'Ein einmal gemachter Verzicht bleibt grundsätzlich bestehen, doch hat der Turnierleiter
innerhalb der Korrekturphase (Regel 79C) einen Verzicht aufzuheben, wenn ein Spieler auf
einen Stich verzichtet hat:

A. den seine Seite tatsächlich gewonnen hat; oder

B. durch kein normales71.1 Spiel der verbleibenden Karten hätte verlieren können.

Dann wird diesem Spieler ein solcher Stich zuerkannt, und das Ergebnis auf dem Board wird
neu berechnet.',
  text_ro = 'O concesie, odată făcută, rămâne valabilă, cu excepția că în limitele Perioadei de
Corecție stabilită prin Legea 79C arbitrul va anula o concesie:

A. Dacă un jucător a cedat o levată pe care de fapt axa sa a câștigat-o; sau

B. Dacă un jucător a cedat o levată care nu ar fi putut fi pierdută prin niciun joc
...
UPDATE rules SET
  text_de = 'A. Beachtung der Regeln
...
regelkonformen Abläufe und ethischen Standards, die in diesen Regeln festgelegt sind.
...
oder vorzeitig seine Karten vermischt.

C. Inkaufnehmen einer möglichen Schädigung
...
totodată procedurile legale și standardele etice stabilite prin aceste legi.
...
amestecând prematur cărțile.

C. Conștientizarea unui Posibil Prejudiciu
...
22 Pentru Legile 70 și 71, „normal” include un joc neglijent sau inferior pentru nivelul jucătorului implicat.'
WHERE number = '72';

UPDATE rules SET
  text_de = 'A. Angebrachter Informationsaustausch zwischen Partnern
...
Sprunggebotwarnung, oder am ersten Stich.

B. Unangebrachter Informationsaustausch zwischen Partnern
...
worden, siehe außerdem Regel 16B3.

D. Unterschiede in Tempo oder Art und Weise
...
korrekten Ablauf (siehe auch Regel 73E2).
E. Täuschung
...
dann soll der Turnierleiter ein Berichtigtes Ergebnis zuweisen.',
  text_ro = 'A. Comunicare Adecvată între Parteneri
...
asupra unui anunț cu salt, sau la prima levată.

B. Comunicare Neadecvată între Parteneri
...
comunicare prestabilite care nu sunt autorizate de aceste Legi.

C. Un Jucător Primește Informație Neautorizată de la Partener
...
adversarii sunt prejudiciați, vezi de asemenea Legea 16B3.

D. Variații de Tempo sau Manieră
...
prin orice abatere intenționată de la procedura corectă.

E. Inducere în Eroare
...
acorda un scor ajustat.'
WHERE number = '73';

UPDATE rules SET
  text_de = 'A. korrekte Einstellung
...
3. Jeder Spieler hat beim Lizitieren und Spielen gleichförmig und korrekt vorzugehen.
...
C. Verstöße gegen den richtigen Ablauf
...
8. den Tisch vor dem Ende der Runde unnötig verlassen.',
  text_ro = 'A. Atitudine Adecvată
...
8. Părăsirea mesei fără motiv înainte de sfârşitul rundei.'
WHERE number = '74';

UPDATE rules SET
  text_de = 'Nachdem den Gegnern eine irreführende Auskunft gegeben worden ist, haben die Spieler
(und der Turnierleiter) folgende Verpflichtungen:

A. Fehler erzeugt unerlaubte Information
...
und den Fehler danach berichtigen.
...
Ergebnis stehen [siehe aber Regel 21B1(b)].

D. Vorgehen des Turnierleiters
...
des wahrscheinlichen Ergebnisses, wenn das den Gegnern mitgeteilt worden wäre.',
  text_ro = 'După ce adversarii au fost induși în eroare de o explicație, responsabilitățile
jucătorilor (și ale arbitrului) sunt următoarele:

A. Greșeală care Cauzează Informație Neautorizată
...
arbitrul și apoi să ofere o corecție.

C. Declarație Greșită
...
Indiferent de prejudiciu, rezultatul rămâne valabil [dar vezi Legea 21B1b)].

D. Decizia Arbitrului
...
spielt, Informationen übermitteln.)
...
von Zuschauern verursacht worden sind, vorzugehen ist.

D. Status
Jede Person im Spielbereich76.1, die weder ein Spieler ist noch zum Turnierpersonal gehört,
hat den Status eines Zuschauers, wenn der Turnierleiter nichts anderes festlegt.',
  text_ro = 'A. Control
...
5. Un spectator nu va atrage atenția asupra niciunui aspect al jocului.
...
gestiona neregularitățile cauzate de spectatori.

D. Statut

Orice persoană din zona de joc24, în afara jucătorilor și a oficialilor turneului, are
statut de spectator dacă arbitrul nu decide altfel.'
WHERE number = '76';

UPDATE rules SET
  text_de = 'Stichergebnis
...
Wenn alle vier Spieler passen (siehe Regel 22), erhält jede Seite als Ergebnis 0 (Null).',
  text_ro = 'Puncte de levată
...
Dacă toţi cei 4 jucători pasează (vezi Legea 22) scorul ambelor axe este zero.'
WHERE number = '77';

UPDATE rules SET
  text_de = 'A. Matchpunkte
...
null Matchpunkte für jedes bessere Ergebnis.

B. Internationale Matchpunkte (IMP)
...
Teilnehmern zur Verfügung stehen.',
  text_ro = 'A. Scorul în Puncte de Meci
...
fiecare rezultat superior rezultatului său.
...
Regulatoare. Ele trebuie puse la dispoziția competitorilor.'
WHERE number = '78';

UPDATE rules SET
  text_de = 'A. Einigkeit über die gewonnenen Stiche
...
B. Uneinigkeit über die gewonnenen Stiche
...
stehen lassen, oder das Ergebnis einer Seite reduzieren, ohne das der anderen zu erhöhen.

C. Fehler beim Eintragen
...
dass die Eintragung falsch ist.',
  text_ro = 'A. Acord asupra Levatelor Câștigate
...
B. Dezacord asupra Levatelor Câștigate
...
fără a crește scorul celeilalte.
...
Verantwortung für ihre Ausübung hat).

B. Turnierveranstalter
...
(l) dazu alle anderen Zuständigkeiten und Pflichten, die ihm in diesen Regeln übertragen sind.',
  text_ro = 'A. Autoritatea Regulatoare
...
l) Orice alte puteri și îndatoriri conferite de aceste legi.'
WHERE number = '80';

UPDATE rules SET
  text_de = 'A. Offizieller Status
Der Turnierleiter ist der offizielle Repräsentant der Turnierveranstalters.

B. Beschränkungen und Verantwortlichkeiten
...
einer Ermächtigung durch diese Regeln erlassen worden sind, an und ist an sie gebunden.
...
melden, und alles andere, was ihm der Turnierveranstalter übertragen hat, zu erledigen.

D. Delegation von Pflichten
Der Turnierleiter kann alle und jede seiner Pflichten seinen Gehilfen delegieren, wird aber
dadurch nicht der Verantwortung für ihre korrekte Durchführung entbunden.',
  text_ro = 'A. Statut Oficial

Arbitrul este reprezentantul oficial al Organizatorului Turneului.

B. Constrângeri și Responsabilități
...
anunţate cu autoritatea conferită de aceste legi.

C. Îndatoririle și Puterile Arbitrului
...
gestioneze orice alte aspecte delegate lui de către Organizatorul Turneului.

D. Delegarea Îndatoririlor

Arbitrul își poate delega oricare dintre îndatoriri asistenților, dar nu este astfel absolvit
de responsabilitatea îndeplinirii corecte a acestora.'
WHERE number = '81';

UPDATE rules SET
  text_de = 'A. Pflicht des Turnierleiters
Der Turnierleiter ist verpflichtet, Fehler im Ablauf richtig zu stellen und den Fortgang des
Turniers in einer Weise zu gewährleisten, die diesen Regeln nicht widerspricht.

B. Korrektur von Fehlern
...
3. alle anderen Befugnisse ausüben, die ihm diese Regeln einräumen.
...
Ergebnis zuzuweisen und dabei beide Seiten als nicht-schuldig zu betrachten.',
  text_ro = 'A. Datoria Arbitrului

Arbitrul este responsabil să rectifice erorile de procedură și să asigure derularea
jocului într-o manieră care nu contravine acestor legi.

B. Rectificarea unei Erori
...
3. Să-și exercite orice altă putere conferită de aceste legi.

C. Eroare de Arbitraj
...
ajustat, considerând în acest caz că ambele axe sunt nevinovate.'
WHERE number = '82';

UPDATE rules SET
  text_de = 'Wenn der Turnierleiter meint, dass eine Überprüfung seiner Entscheidung in einer Tatsachen-
...
Komitee vorlegen.',
  text_ro = 'Dacă arbitrul crede că ar putea fi cazul să se revizuiască o decizie a sa privind
faptele sau un exercițiu al puterii sale discreționare, el va înștiința concurentul asupra
dreptului său de a face apel sau va înainta cazul unei comisii adecvate.'
WHERE number = '83';

UPDATE rules SET
  text_de = 'Wenn der Turnierleiter gerufen wird, um eine Regel- oder Tatsachenfrage zu entscheiden, und
über die Tatsachen Einigkeit besteht, geht er folgendermaßen vor:

A. keine Korrektur
Wenn die Regeln keine Korrektur vorschreiben, und er keinen Anlass hat, seine
Ermessensbefugnis auszuüben, ordnet er an, dass die Spieler Lizitation oder Spiel fortsetzen.

B. Regeln sehen eine Korrektur vor
Wenn der Vorfall klar von einer Regel abgedeckt ist, stellt er die in dieser Regel für diese
Regelwidrigkeit vorgeschriebene Korrektur fest und stellt sicher, dass sie durchgeführt wird.

C. Wahlmöglichkeit eines Spielers
...
D. Wahlmöglichkeit des Turnierleiters
...
Ergebnis zu (siehe Regel 12).',
  text_ro = 'Când este chemat să decidă asupra unui punct de lege sau regulament și faptele
sunt consimțite, arbitrul procedează după cum urmează:

A. Nicio Rectificare

Dacă legea nu prevede nicio rectificare şi nu este o situație în care el să-şi exercite
puterile discreţionare, instruiește jucătorii să continue licitaţia şi jocul.

B. Rectificare Prevăzută de Lege

Dacă situația este clar acoperită de o Lege care prescrie rectificarea pentru
neregularitate, determină acea rectificare și se asigură că este implementată.

C. Opțiunea Jucătorului

Dacă o Lege îi dă unui jucător posibilitatea de a alege o rectificare, arbitrul explică
opțiunile și are grijă ca alegerea să fie făcută și implementată.

D. Opțiunea Arbitrului
...
ajustează scorul (vezi Legea 12).'
WHERE number = '84';

UPDATE rules SET
  text_de = 'Wenn der Turnierleiter gerufen wird, um eine Regel- oder Tatsachenfrage zu entscheiden, und
über die Tatsachen keine Einigkeit besteht, geht er folgendermaßen vor:

A. Beweiswürdigung des Turnierleiters
...
entscheidet er nach Regel 84.

B. Tatsachen nicht festgestellt
Wenn der Turnierleiter nicht in der Lage ist, die Tatsachen festzustellen, trifft er eine
Entscheidung, die es ermöglicht, das Spiel fortzusetzen.',
  text_ro = 'Când este chemat să decidă asupra unui punct de lege sau regulament în care
faptele nu sunt consimțite, arbitrul procedează după cum urmează:

A. Aprecierea Arbitrului
...
2. Dacă apoi arbitrul consideră că a determinat faptele, decide ca în Legea 84.

B. Faptele Nu Pot Fi Stabilite

Dacă arbitrul nu reușește să stabilească faptele într-o măsură satisfăcătoare, el ia o
decizie care va permite ca jocul să continue.'
WHERE number = '85';

UPDATE rules SET
  text_de = 'A. Ersatzboard
...
bekannt sein könnte. Stattdessen weist er ein Berichtigtes Ergebnis zu.

B. Ergebnis am anderen Tisch erzielt
...
jucător. În schimb, el acordă un scor ajustat.

B. Rezultat Obținut la Cealaltă Masă
...
Turnierleiter seine Methode und gibt sie bekannt.)
...
nu au jucat dona în formă identică.

B. Calcularea Scorului în Jocul de Perechi sau Individual
...
relevante, arbitrul își alege și își face cunoscută metoda.)

C. Calcularea Scorului în Jocul de Echipe
...
UPDATE rules SET
  text_de = 'Siehe Regel 12C3.',
  text_ro = 'Vezi Legea 12C3.'
WHERE number = '89';

UPDATE rules SET
  text_de = 'A. Befugnis des Turnierleiters
...
Zuweisen eines Berichtigten Ergebnisses erfordert.

B. Verstöße, die einer Ordnungsstrafe unterliegen
...
Turnierleiters nicht prompt befolgt.',
  text_ro = 'A. Autoritatea Arbitrului
...
cauzează acordarea unui scor ajustat.

B. Abateri care Fac Obiectul Penalizărilor Procedurale
...
UPDATE rules SET
  text_de = 'A. Befugnisse des Turnierleiters
...
Turnierleiters ist endgültig (siehe Regel 93B3).

B. Disqualifikation
Der Turnierleiter ist ermächtigt, mit Zustimmung des Turnierveranstalters einen Spieler oder
Teilnehmer aus einem gerechten Grund zu disqualifizieren.',
  text_ro = 'A. Puterile Arbitrului
...
finală (vezi Legea 93B3).

B. Dreptul de a Descalifica

Arbitrul are puterea să descalifice un jucător sau concurent dintr-o anumită cauză, cu
aprobarea Organizatorului Turneului.'
WHERE number = '91';

UPDATE rules SET
  text_de = 'A. Rechte der Teilnehmer
...
2. in einem Teamturnier der Kapitän der Berufung zustimmt.',
  text_ro = 'A. Dreptul Concurentului
...
supusă unei sancțiuni impuse de regulament.

B. Termenul pentru Apel
...
specificat un alt termen.

C. Cum se Face un Apel

Toate cererile de revizuire a unei decizii vor fi făcute prin intermediul arbitrului.

D. Acord între Apelanți
...
2. Într-un concurs de echipe, căpitanul echipei este de acord cu efectuarea apelului.'
WHERE number = '92';

UPDATE rules SET
  text_de = 'A. kein Turnierkomitee
...
oder wenn dieses ohne Störung des Turnierverlaufs nicht zusammentreten kann.

B. Turnierkomitee vorhanden
...
kann dem Oberturnierleiter empfehlen, eine solche Entscheidung zu ändern.)
...
5
5B',
  text_ro = 'A. Nu Există un Juriu de Apel
...
comitet nu poate opera fără a deranja desfăşurarea normală a turneului.

B. Există un Juriu de Apel
...
C. Posibilități de a Face Apel Mai Departe
